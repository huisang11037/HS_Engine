...
#include "..\\HSEngine_Window\\hsToolScene.h"
...
BOOL                InitToolScene(HINSTANCE, UINT);
...
BOOL InitToolScene(HINSTANCE hInstance, UINT mainWidth)
{
    ...
    if (name == L"ToolScene")
    {
        ...
        SetWindowPos(ToolHWnd, nullptr, mainWidth + 10, 0, toolWidth, toolHeight, 0);
